...
public final class BClockConstants {
    ...
    public static final int HOUR_LAMPS_IN_TOP_ROW = 4;
    public static final int HOUR_LAMPS_IN_BOTTOM_ROW = 4;
	public static final int MINUTES_LAMPS_IN_TOP_ROW = 11;
    public static final int MINUTES_LAMPS_IN_BOTTOM_ROW = 4;
